    ...
    for i in scan_dir(os.path.abspath(dir_path)):
        ...
        if fs_file.get(i):
            ...
            if os.path.isdir(filepath):
                uid = "0"
                if "system/bin" in i or "system/xbin" in i or "vendor/bin" in i or "system_ext/xbin" in i or "system_ext/bin" in i:
                    gid = "2000"
                else:
                    gid = "0"
                ...
                uid = "0"
                if ("system/bin" in i) or ("system/xbin" in i) or ("vendor/bin" in i) or ("system_ext/xbin" in i) :
                    gid = "2000"
                else:
                    gid = "0"
